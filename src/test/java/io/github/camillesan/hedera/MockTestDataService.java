...
public class MockTestDataService {
    ...
    public final String christmasExpense = "Christmas Gift";
    public final String aprilBonus = "Easter Bonus";
    public final String julyBonus = "Summer Bonus";
    public final String user2Expense = "From user 2 expense";
    public final String user2Income = "From user 2 income";
    ...
    public void init() {
        ...
        testUser1.setEmail("bruce.willis@email.com");
        ...
        se11.setLabel(christmasExpense);
